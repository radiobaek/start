...
public class PreferenceConstants {
	public static final String PREF_AddToNewTab = "net.opensg.tcs.main.preference.C_AddToNewTab";

	public static final String PREF_SamplePopupField1Name = "net.opensg.tcs.main.preference.C_SamplePopupField1Name";
